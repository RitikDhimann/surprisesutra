                ...
                >
                    ...
                    <div className="flex flex-col items-center mb-10 md:mb-12 mt-12 md:mt-0">
                        ...
                        <h1 className="text-2xl md:text-4xl font-heading font-black text-brand-brown tracking-tighter mb-4 text-center leading-tight">
                            {step === 1 ? <>Reset <span className="text-brand-primary">Magic!</span></> : <>New <span className="text-brand-primary">Magic Key</span></>}
                        </h1>
                        ...
                        {step === 1 ? (
                            ...
                            >
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <label className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-brand-brown/40 ml-4 md:ml-6">New Magic Key</label>
                                        <div className="relative group">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-brand-brown/40 ml-4 md:ml-6">Confirm Key</label>
                                        <div className="relative group">
