    ...
    <footer className="bg-white border-t border-gray-100 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12 mb-12">
          ...
          {/* Links 1 */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-widest text-[#c73020] mb-6">Quick Links</h4>
          ...
          {/* Links 2 */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-widest text-[#c73020] mb-6">Support</h4>
            <ul className="space-y-3 text-sm font-medium text-gray-600">
              <li><Link to="/privacy-policy" className="hover:text-[#c73020] transition-colors">Privacy Policy</Link></li>
              <li><Link to="/terms-and-conditions" className="hover:text-[#c73020] transition-colors">Terms of Play</Link></li>
              <li><Link to="/faqs" className="hover:text-[#c73020] transition-colors">FAQs</Link></li>
            </ul>
          </div>

          {/* Contact & Socials */}
          <div className="md:col-span-1">
             <h4 className="text-xs font-black uppercase tracking-widest text-[#c73020] mb-6">Connect</h4>
             <div className="space-y-4 mb-6">
               <a href="mailto:surprisesutra@gmail.com" className="flex items-center gap-3 text-sm text-gray-600 hover:text-[#c73020]">
                 <Mail size={16} />
